...
\sigma^2 & :=\var(Y)
=\Ex\bigl[(Y-\mu)^2\bigr] = \Ex(Y^2) - \bigl[\Ex(Y)]^2 \text{ is the }\alerttext{variance}\text{ of } Y
\\
...
The Bernoulli distribution, $\Bern(p)$, is the case $n=1$
...
## Multivariate normal distribution {.tree-marker-slide tree-marker="probability"}
