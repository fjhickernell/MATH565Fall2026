...
::: {.columns}
::: {.column width="50%"}
- **Finance:** market forces and option payoffs
- **Engineering:** variable system parameters
- **Image rendering:** only finitely many rays can be traced
:::

::: {.column width="50%"}
- **Bayesian inference:** posterior uncertainty after observing data
- **Neural networks:** high-dimensional parameter searches
- **Queues:** uncertain arrival and service times
:::
:::
...
::: {.incremental}
- **Finance:** stochastic processes, often driven by Brownian motion
- **Engineering:** variability modeled, for example, by Gaussian processes
- **Image rendering:** a finite sample must stand in for all possible rays
- **Bayesian inference:** the posterior combines prior information and data
